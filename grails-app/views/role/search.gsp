...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="list-role" class="col-12 content scaffold-list" role="main">
                    ...
                    <p>
                        Searched "${roleInstanceTotal}" records for items matching <em>"${searchText}"</em>. Found <strong>"${roleInstanceList.size()}"</strong>.
                    </p>
                    <f:table collection="${roleInstanceList}" />

                    <g:if test="${roleCount > params.int('max')}">
