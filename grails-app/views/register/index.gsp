        ...
        <div class="card-body">
          <h5 class="card-title text-center">Register Here</h5>
              ...
              <div class="form-group">
                  ...
                  <label for="role">ROLE_USER</label>
                </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="First Name" class="form-control" name="name" id="name" autocapitalize="none"/>
            </div>
            <div class="form-group">
              <label for="lastName">Last Name</label>
              <input type="text" placeholder="Last Name" class="form-control" name="lastName" id="lastName" autocapitalize="none"/>
            </div>
            <div class="form-group">
              <label for="email">Email</label>
              <input type="text" placeholder="Email" class="form-control" name="email" id="email" autocapitalize="none"/>
            </div>
