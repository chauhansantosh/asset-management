        ...
        <div class="container">
            ...
            <section class="row">
                <div id="list-user" class="col-12 content scaffold-list" role="main">
                    ...
                    <p>
                        Searched "${userInstanceTotal}" records for items matching <em>"${searchText}"</em>. Found <strong>"${userInstanceList.size()}"</strong>.
                    </p>
                    <f:table collection="${userInstanceList}" except="['id','password']" />
