        ...
        <div class="container">
            ...
            <section class="row">
                <div id="list-location" class="col-12 content scaffold-list" role="main">
                    ...
                    <p>
                        Searched "${locationInstanceTotal}" records for items matching <em>"${searchText}"</em>. Found <strong>"${locationInstanceList.size()}"</strong>.
                    </p>
                    <f:table collection="${locationInstanceList}" />
