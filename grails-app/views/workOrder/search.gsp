...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="list-workOrder" class="col-12 content scaffold-list" role="main">
                    ...
                    <p>
                        Searched ${workOrderInstanceTotal} records for items matching <em>"${searchText}"</em>. Found <strong>${workOrderInstanceList.size()}</strong>.
                    </p>
                    <f:table collection="${workOrderInstanceList}" />

                    <g:if test="${workOrderCount > params.int('max')}">
                    <div class="pagination">
                        <g:paginate total="${workOrderCount ?: 0}" />
                    </div>
                    </g:if>
                </div>
            </section>
